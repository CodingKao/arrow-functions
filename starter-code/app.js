...
//  When joe.scope() is invoked, this refers to the joe object.

// 2. What is "this" when joe.scopeArrow() is invoked?
//  When joe.scopeArrow() is invoked, this refers to the global object (or window object in a browser).

// 3. Explain why "this" is different when an arrow function is used.
//  Arrow functions do not have their own "this" context and instead inherit the "this" value from the surrounding context, which is the global object in the case of joe.scopeArrow(). In contrast, regular functions have their own "this" context, which is determined by the way in which they are invoked. When called as a method of an object, "this" refers to the object instance. When called as a standalone function, "this" refers to the global object.